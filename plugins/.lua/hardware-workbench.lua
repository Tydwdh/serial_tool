...
---@field create_table fun(config: HwPanelConfig)
...
---@field set_values fun(panel_id: string, values: table)
---@field table_set_rows fun(panel_id: string, rows: table[])
---@field table_append_rows fun(panel_id: string, rows: table[])
---@field table_remove_rows fun(panel_id: string, row_ids: string[])
---@field table_clear fun(panel_id: string)
